...
import io.crim.android.ouiconversation.databinding.ActivityMsgReadStatusBinding;
...
public class MsgReadStatusActivity extends BaseActivity<GroupVM, ActivityMsgReadStatusBinding> {
    ...
    private void initView() {
        view.title1.setText(String.format(getString(io.crim.android.ouicore.R.string.readed), vm.hasReadIDList.size() + ""));
    ...
    private void listener() {
        vm.groupsInfo.observe(this, groupInfo -> {
            view.title2.setText(String.format(getString(io.crim.android.ouicore.R.string.unread),
