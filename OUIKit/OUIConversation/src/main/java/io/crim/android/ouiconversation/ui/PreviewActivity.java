...
import cn.jzvd.Jzvd;
import io.crim.android.ouiconversation.databinding.ActivityPreviewBinding;
        ...
        if (MediaFileUtil.isImageType(url)) {
            ...
            view.download.setOnClickListener(v -> {
                Common.permission(this, () -> {
                    hasWrite = true;
                    toast(getString(io.crim.android.ouicore.R.string.start_download));
                    Common.downloadFile(url, null,
                        ...
                        public void onSuccess(Boolean success) {
                            if (success)
                                toast(getString(io.crim.android.ouicore.R.string.save_succ));
                            else
                                toast(getString(io.crim.android.ouicore.R.string.save_photo_album));
                        }
